...
print('Uso do operador "porcentagem" para string: %s %s' % (string1, string2))

# Python Version >= 3.7
string = 'uma string'
print(f'Uma string com interpolacao: {string}')
...
print(
    ...
    'de no maximo 79-80 caracteres de codigo em uma linha, tente usar ela.
    'Nao tem problema se passar de 80 ou chegar ateh uns 85 caracteres. ' 
    'Essa formatacao de "print" tambem pode ser usada nos codigos.')
